...
- [FlashAttention Is an IO Algorithm](../../posts/flashattention-io-aware/index.qmd) makes the case for treating attention as a memory problem.
- [The Rank of Memory](../../posts/rank-of-memory/index.qmd) asks what the cache is buying in the first place.
- [Speculative Sampling Preserves the Target Distribution](../../notes/speculative-sampling/index.qmd) adds sequences that this allocator has to hold.
