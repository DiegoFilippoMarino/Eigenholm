...
- [The Arithmetic of Editing a Fact](../../posts/arithmetic-of-editing-a-fact/index.qmd) solves a closely related problem, least squares in a data-defined metric.
- [FlashAttention Is an IO Algorithm](../../posts/flashattention-io-aware/index.qmd) explains the bandwidth bound that makes low-bit weights pay.
- [Three Ways a Curve Bends](../../posts/three-ways-a-curve-bends/index.qmd) covers the scaling behaviour behind outlier features.
