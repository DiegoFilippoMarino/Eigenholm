...
\left(\left\{h_u^{(\ell)}:u\in\mathcal N(v)\right\}\right),
$$
...
The braces denote a multiset. Permuting the neighbors cannot change the aggregate. This is the correct symmetry for an unlabeled graph, and it imposes an information constraint.
